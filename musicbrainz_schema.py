...
def make_link_entity_list(entities):
    ...
    return [
        "l_%s_%s" % (e0, e1) for e0, e1 in linked_entities
...
mbschema = Schema([
    ...
    Entity(
        ...
        [
            ...
            Property(
                'type',
                Column('type', ForeignColumn('area_type', 'name', null=True))),
        ],
    ),
    Entity('area_alias', [
        IntegerProperty('pk', Column('id')),
        ...
        Property(
            'type',
            Column('type', ForeignColumn('area_alias_type', 'name',
                                         null=True))),
    ...
    Entity(
        ...
        [
            ...
            Property(
                'type',
                Column('type', ForeignColumn('place_type', 'name',
                                             null=True))),
    ...
    Entity('place_alias', [
        ...
        Property(
            'type',
            Column('type', ForeignColumn('place_alias_type', 'name',
                                         null=True))),
        Property('locale', Column('locale')),
    ], [
        Relation('HAS_ALIAS',
    ...
    Entity(
        ...
        [
            ...
            Property(
                'type',
                Column('type', ForeignColumn('artist_type', 'name',
                                             null=True))),
            ...
            Property(
                'gender',
                Column('gender', ForeignColumn('gender', 'name', null=True))),
        ],
        [
            Relation('FROM_AREA',
                     ...
                     properties=[]),
            Relation('BEGAN_IN_AREA',
                     start=Reference('artist', Column('id')),
                     end=Reference('area', Column('begin_area')),
                     properties=[]),
            Relation('ENDED_IN_AREA',
                     start=Reference('artist', Column('id')),
    ...
    Entity('artist_alias', [
        ...
        Property(
            'type',
            Column('type', ForeignColumn(
                'artist_alias_type', 'name', null=True))),
    ], [
        Relation('HAS_ALIAS',
    ...
    Entity('artist_credit_name',
           fields=[],
           relations=[
               Relation('CREDITED_AS',
                        start=Reference('artist', Column('artist')),
                        end=Reference('artist_credit', Column(
                            'artist_credit')),
                        properties=[
    ...
    Entity(
        ...
        [
            ...
            Property(
                'type',
                Column('type', ForeignColumn('label_type', 'name',
                                             null=True))),
    ...
    Entity(
        ...
        [
            ...
            Property(
                'type',
                Column('type', ForeignColumn('work_type', 'name', null=True))),
        ],
        # no relationships
        []),
    Entity('work_type', [
    ...
    Entity(
        ...
        [
            ...
            Property(
                'status',
                Column('status',
                       ForeignColumn('release_status', 'name', null=True))),
            Property(
                'packaging',
                Column('packaging',
                       ForeignColumn('release_packaging', 'name', null=True))),
    ...
    Entity('medium', [
        ...
        Property(
            'format',
            Column('format', ForeignColumn('medium_format', 'name',
                                           null=True))),
    ], [
        Relation('RELEASED_ON_MEDIUM',
                 start=Reference('release', Column('release')),
